...
function komodo_label_lookup(string $key, string $domain): ?string
{
    return match ($domain) {
        ...
        'db_object' => match ($key) {
            ...
            'vw_market_data_import_plan' => 'Market data import plan',
...
function komodo_desc_lookup(string $key, string $domain): ?string
{
    return match ($domain) {
        ...
        'db_object' => match ($key) {
            ...
            'vw_security_price_import_targets' => 'Securities in scope for price import, segmented by role (event-linked vs comparison).',
